...
class HomeViewModel: ObservableObject {
    ...
    func fetchCoinData() {
        let urlString =  "https://api.coingecko.com/api/v3/coins/markets?vs_currency=inr&order=market_cap_desc&per_page=50=&page=1&sparkline=true&price_change_percentage=24h"
